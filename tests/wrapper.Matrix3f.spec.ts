...
import { Matrix3f as Matrix } from '@library'
import { Vector3f as Vector } from '@library'

describe('matrix.Matrix3f', function () {
  ...
  describe('#constructor', function () {
    it('allow to create a new empty matrix instance', function () {
      expect(new Matrix().buffer).toEqual(new Float32Array([
        0, 0, 0, 
        0, 0, 0, 
        0, 0, 0
      ]))
  ...
  describe('#copy', function () {
    it('allow to copy the content of another matrix', function () {
      ...
      expect(result.buffer).toEqual(new Float32Array([
        -1.0, 14.375, 16.375,
        6.125, -17.875, 14.0,
        -7.5, -3.0, 9.25
      ]))
  ...
  describe('#multiplyWithMatrix', function () {
    it('allow to multiply the current matrix with another', function () {
      ...
      expect(right.buffer).toEqual(new Float32Array([
        -2.0, 28.75, 32.75, 
        12.25, -35.75, 28.0, 
        -15.0, -6.0, 18.5
      ]))
  ...
  describe('#extractScale', function () {
    it('allow to extract a scale vector from the matrix', function () {
      ...
      expect(scale.buffer).toEqual(new Float32Array([
        1, 2, 3
      ]))
    })
  })
