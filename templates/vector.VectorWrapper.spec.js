...
describe('vector.Vector/*$ dimension $*//*$ vector_type $*/', function () {
  ...
  describe('#wrap', function () {
    it('allows to wrap an existing buffer into a new Vector instance', function () {
      const buffer = new /*$ vector_buffer_type $*/([
        /*$ ', '.join(to_tokens(random_vector(0))) $*/
      ])

      const vector = Vector.wrap(buffer)
  ...
  describe('#clone', function () {
    it('allows to clone an existing vector', function () {
      const vector = Vector.create(/*$ ', '.join(to_tokens(random_vector(0))) $*/)
      const clone = Vector.clone(vector)
  ...
  describe('#copy', function () {
    it('copy another vector', function () {
      const base = Vector.create(/*$ ', '.join(to_tokens(random_vector(0))) $*/)
      const toCopy = Vector.create(/*$ ', '.join(to_tokens(random_vector(1))) $*/)
  ...
  describe('#add', function () {
    it('add another vector', function () {
      ...
      const right = Vector.create(/*$ ', '.join(to_tokens(random_vector(1))) $*/)
  ...
  describe('#equals', function () {
    it('check if two vectors are equals', function () {
      const a = Vector.create(/*$ ', '.join(to_tokens(random_vector(0))) $*/)
      const b = Vector.clone(a)
      const c = Vector.create(/*$ ', '.join(to_tokens(random_vector(1))) $*/)
